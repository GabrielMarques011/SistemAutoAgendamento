...
export default function ScreenCabeamento5({ formData, prevStep, onReset }) {
  ...
  if (successData) {
    return (
      <div className="h-full flex flex-col">
        {/* Header da Tela */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Problemas de Cabeamento Fora do Padrão!</h2>
          <p className="text-gray-600 text-lg">Seu problema de cabeamento fora do padrão foi agendado com sucesso</p>
        </div>
        ...
        <div className="space-y-6 flex-1">
          ...
          <div className="bg-green-50 rounded-xl p-6 border border-green-200">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-green-800">Problemas de Cabeamento Confirmados</h3>
            </div>
...
*Data/Período:* ${successData.dataPeriodo}`}
          ...
          <div className="flex justify-center pt-6">
            ...
            >
              ...
              Nova Abertura de Cabeamento Fora do Padrão
            </button>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header da Tela */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-3">Revisão do Cabeamento Fora do Padrão</h2>
        <p className="text-gray-600 text-lg">Revise os dados antes de finalizar o Cabeamento Fora do Padrão</p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700">
                Ao finalizar, será criado um ticket de problema de Cabeamento Fora do Padrão. 
