...
export default function ScreenAlarmada5({ formData, prevStep, onReset }) {
  ...
  const handleFinalize = async () => {
    ...
    try {
      ...
      const resQuedas = await fetch("http://10.0.30.251:5000/api/alarmada", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  if (successData) {
    return (
      <div className="h-full flex flex-col">
        {/* Header da Tela */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Alarmada Concluída!</h2>
          <p className="text-gray-600 text-lg">Sua alarmada foi agendada com sucesso</p>
        </div>
        ...
        <div className="space-y-6 flex-1">
          ...
          <div className="bg-green-50 rounded-xl p-6 border border-green-200">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-green-800">Alarmada Confirmada</h3>
            </div>
...
*Data/Período:* ${successData.dataPeriodo}`}
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header da Tela */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-3">Revisão da Alarmada</h2>
        <p className="text-gray-600 text-lg">Revise os dados antes de finalizar a alarmada</p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700">
                Ao finalizar, será criado um ticket de alarmada. 
