...
export default function ScreenRoteador5({ formData, prevStep, onReset }) {
  ...
  const handleFinalize = async () => {
    ...
    try {
      ...
      const resQuedas = await fetch("http://10.0.30.251:5000/api/config", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  if (successData) {
    return (
      <div className="h-full flex flex-col">
        {/* Header da Tela */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Configuração de Roteador Concluída!</h2>
          <p className="text-gray-600 text-lg">Sua configuração de roteador foi agendada com sucesso</p>
        </div>
        ...
        <div className="space-y-6 flex-1">
          ...
          <div className="bg-green-50 rounded-xl p-6 border border-green-200">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-green-800">Configuração de Roteador Confirmada</h3>
            </div>
...
*Data/Período:* ${successData.dataPeriodo}`}
          ...
          <div className="flex justify-center pt-6">
            ...
            >
              ...
              Nova Abertura de Configuração de Roteador
            </button>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header da Tela */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-3">Revisão da Configuração de Roteador</h2>
        <p className="text-gray-600 text-lg">Revise os dados antes de finalizar a configuração de roteador</p>
      </div>
