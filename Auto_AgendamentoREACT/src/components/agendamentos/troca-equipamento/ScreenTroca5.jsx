...
export default function ScreenTroca5({ formData, prevStep, onReset }) {
  ...
  if (successData) {
    return (
      <div className="h-full flex flex-col">
        {/* Header da Tela */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Troca de Equipamento Concluída!</h2>
          <p className="text-gray-600 text-lg">Sua troca de equipamento foi agendada com sucesso</p>
        </div>
        ...
        <div className="space-y-6 flex-1">
          ...
          <div className="bg-green-50 rounded-xl p-6 border border-green-200">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-green-800">Troca de Equipamento Confirmada</h3>
            </div>
...
*Data/Período:* ${successData.dataPeriodo}`}
          ...
          <div className="flex justify-center pt-6">
            ...
            >
              ...
              Nova Abertura de Troca de Equipamento
            </button>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header da Tela */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-3">Revisão da Troca de Equipamento</h2>
        <p className="text-gray-600 text-lg">Revise os dados antes de finalizar a troca de equipamento</p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700">
                Ao finalizar, será criado um ticket de troca de equipamento. 
